...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: `API Documentation | ${BRAND_NAME}`,
    description:
      "Complete documentation for the IsLeapYear API. Learn how to integrate our high-performance leap year detection service into your applications.",
    url: "/docs",
    type: "website",
...
const DocsPage = () => {
  const structuredData: WithContext<TechArticle> = {
    "@context": "https://schema.org",
    "@type": "TechArticle",
    headline: "IsLeapYear API Documentation",
    description:
      "Complete API documentation for integrating leap year detection into your applications.",
